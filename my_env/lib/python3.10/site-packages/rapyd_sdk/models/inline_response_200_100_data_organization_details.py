...
from .inline_response_200_100_data_organization_details_merchant_customer_support import (
    InlineResponse200_100DataOrganizationDetailsMerchantCustomerSupport,
)


@JsonMap({})
class InlineResponse200_100DataOrganizationDetails(BaseModel):
    ...
    :type merchant_customer_support: InlineResponse200_100DataOrganizationDetailsMerchantCustomerSupport, optional
    """
    ...
    def __init__(
        ...
        merchant_customer_support: InlineResponse200_100DataOrganizationDetailsMerchantCustomerSupport = None,
    ):
        """InlineResponse200_100DataOrganizationDetails
