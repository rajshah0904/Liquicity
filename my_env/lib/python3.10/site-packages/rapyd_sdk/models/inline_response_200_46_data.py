...
from .inline_response_200_44_data_transactions import (
    InlineResponse200_44DataTransactions,
)


@JsonMap({"id_": "id"})
class InlineResponse200_46Data(BaseModel):
    ...
    :type transactions: List[InlineResponse200_44DataTransactions], optional
    """
    ...
    def __init__(
        ...
        currency: str = None,
        transactions: List[InlineResponse200_44DataTransactions] = None,
    ):
        """InlineResponse200_46Data
        ...
        self.transactions = self._define_list(
            transactions, InlineResponse200_44DataTransactions
        )
