...
class SkusSkuIdBody(BaseModel):
    ...
    :param inventory: inventory object {quantity, type, value}, defaults to None
    :type inventory: V1skusskuIdInventory, optional
    :param price: The amount of the price. Decimal., defaults to None
    :type price: float, optional
    :param product: ID of the product that this SKU relates to. The type field of the product must be set to goods., defaults to None
    ...
    def __init__(
        self,
        currency: str = None,
        inventory: V1skusskuIdInventory = None,
        price: float = None,
        product: str = None,
        active: bool = None,
