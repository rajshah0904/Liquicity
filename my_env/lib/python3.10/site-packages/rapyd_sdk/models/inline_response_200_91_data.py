...
@JsonMap({"id_": "id"})
class InlineResponse200_91Data(BaseModel):
    ...
    :type transactions: List[InlineResponse200_91DataTransactions], optional
    ...
    def __init__(
        ...
        currency: str = None,
        transactions: List[InlineResponse200_91DataTransactions] = None,
        ...
        self.transactions = self._define_list(
            transactions, InlineResponse200_91DataTransactions
        )
