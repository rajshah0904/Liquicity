...
@JsonMap({})
class InlineResponse200_116Data(BaseModel):
    ...
    :type application_type: InlineResponse200_116DataApplicationType, optional
    :param organization_details: organization_details, defaults to None
    :type organization_details: InlineResponse200_116DataOrganizationDetails, optional
    :param renew_result: renew_result, defaults to None
    :type renew_result: InlineResponse200_116DataRenewResult, optional
    """
    ...
    def __init__(
        ...
        application_type: InlineResponse200_116DataApplicationType = None,
        organization_details: InlineResponse200_116DataOrganizationDetails = None,
        renew_result: InlineResponse200_116DataRenewResult = None,
    ):
        """InlineResponse200_116Data
        ...
        self.application_type = self._define_object(
            application_type, InlineResponse200_116DataApplicationType
        )
        self.organization_details = self._define_object(
            organization_details, InlineResponse200_116DataOrganizationDetails
        )
        self.renew_result = self._define_object(
            renew_result, InlineResponse200_116DataRenewResult
        )
