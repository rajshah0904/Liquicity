...
@JsonMap({"id_": "id"})
class HostedPageCardPinResponse(BaseModel):
    ...
    :param card_issuing: ID of the card. String starting with **card_**., defaults to None
    :type card_issuing: str, optional
    :param card_token: ID of the Issued Card object, a string starting with **ci_**., defaults to None
    ...
    :param skip_view_pin: When **true**, the customer cannot reset the PIN via a hosted page., defaults to None
    :type skip_view_pin: bool, optional
    ...
    def __init__(
        ...
        self.card_issuing = self._define_str(
            "card_issuing", card_issuing, nullable=True
        )
        self.card_token = self._define_str("card_token", card_token, nullable=True)
        ...
        self.skip_view_pin = skip_view_pin
        self.status = (
