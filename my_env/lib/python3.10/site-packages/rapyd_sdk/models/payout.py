...
class PayoutPayoutType(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, PayoutPayoutType._member_map_.values()))
...
class Payout(BaseModel):
    ...
    :type payout_type: PayoutPayoutType, optional
    ...
    def __init__(
        ...
        payout_type: PayoutPayoutType = None,
        sender: Sender = None,
        ...
        self.payout_type = (
            self._enum_matching(payout_type, PayoutPayoutType.list(), "payout_type")
            if payout_type
            else None
        )
