...
from circle import rest, __version__
from circle.configuration import Configuration
from circle.exceptions import ApiTypeError, ApiValueError
from circle.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = f"CirclePython/{__version__}"
