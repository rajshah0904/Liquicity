...
SchemaFor200ResponseBodyApplicationJson = ListCheckoutSessionsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_checkout_sessions_oapg(
        self,
...
class ListCheckoutSessions(BaseApi):
    ...
    def list_checkout_sessions(
        ...
        return self._list_checkout_sessions_oapg(
