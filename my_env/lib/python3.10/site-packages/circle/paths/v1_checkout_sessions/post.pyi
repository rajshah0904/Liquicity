...
# body param
SchemaForRequestBodyApplicationJson = CheckoutSessionCreationRequest


request_body_checkout_session_creation_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CreateCheckoutSessionResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_checkout_session_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_checkout_session_creation_request.serialize(body, content_type)
