...
# body param
SchemaForRequestBodyApplicationJson = ExtendCheckoutSessionRequest


request_body_extend_checkout_session_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ExtendCheckoutSessionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _extend_checkout_session_oapg(
        self,
    ...
    def _extend_checkout_session_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_extend_checkout_session_request.serialize(body, content_type)
...
class ExtendCheckoutSession(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def extend_checkout_session(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def extend_checkout_session(
        ...
        return self._extend_checkout_session_oapg(
            body=body,
