...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_business_recipient_address_oapg(
        self,
...
class DeleteBusinessRecipientAddress(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_business_recipient_address(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_business_recipient_address(
        ...
        return self._delete_business_recipient_address_oapg(
