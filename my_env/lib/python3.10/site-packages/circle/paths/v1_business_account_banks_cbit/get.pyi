...
SchemaFor200ResponseBodyApplicationJson = ListBusinessCbitAccountsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_business_cbit_accounts_oapg(
        self,
...
class ListBusinessCbitAccounts(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_business_cbit_accounts(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def list_business_cbit_accounts(
        ...
        return self._list_business_cbit_accounts_oapg(
