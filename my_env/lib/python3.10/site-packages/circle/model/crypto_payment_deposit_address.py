...
class CryptoPaymentDepositAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["chain", "address", "addressTag", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["chain", "address", "addressTag", ], str]):
