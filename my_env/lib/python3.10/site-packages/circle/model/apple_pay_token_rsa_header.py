...
class ApplePayTokenRsaHeader(
    ...
    wrappedKey: MetaOapg.properties.wrappedKey
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["wrappedKey"]) -> MetaOapg.properties.wrappedKey: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["wrappedKey", "publicKeyHash", "transactionId", "applicationData", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wrappedKey"]) -> MetaOapg.properties.wrappedKey: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["wrappedKey", "publicKeyHash", "transactionId", "applicationData", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        wrappedKey: typing.Union[MetaOapg.properties.wrappedKey, str, ],
