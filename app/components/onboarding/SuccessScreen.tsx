...
import KYCLiteForm from "../components/onboarding/KYCLiteForm";
...
const SuccessScreen: React.FC<SuccessScreenProps> = ({ 
  ...
  const getStatusContent = () => {
    switch (status) {
      case 'approved':
        return {
          icon: <Check size={48} className="text-green-500 mx-auto mb-4" />,
      ...
      default:
        return {
          icon: <Clock size={48} className="text-blue-500 mx-auto mb-4" />,
