/*
Author: Hrishi Mehta
Project: TerraBankChain
Description: Cross-currency, multi-bank ledger system for Hyperledger Fabric
...
// Define the customer , with 3 properties.  Structure tags are used by encoding/json library
type Customer struct {
	Name       string   `json:"name"`
	//could use SurName - 04.08.25
...
// CreateBank creates on bank on the public channel.
...
func (s *SmartContract) CreateCustomer(ctx contractapi.TransactionContextInterface, custid string, password string, name string, lastname string) error {
...
func (s *SmartContract) UpdateProfile(ctx contractapi.TransactionContextInterface, custid string, name string, lastname string, password string) error {
